          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    Expanded(
                      child: _NumberField(
                        ...
                        primaryColor: primaryColor,
                        onChanged: (v) =>
                            onSettingsChanged(topPadding: v.toDouble()),
                      ),
                    ),
                    const SizedBox(width: 8),
                    Expanded(
                      child: _NumberField(
                        ...
                        primaryColor: primaryColor,
                        onChanged: (v) =>
                            onSettingsChanged(bottomPadding: v.toDouble()),
                      ),
                    ),
                  ],
                ),
                  ...
                  children: [
                    Expanded(
                      child: _NumberField(
                        ...
                        primaryColor: primaryColor,
                        onChanged: (v) =>
                            onSettingsChanged(leftPadding: v.toDouble()),
                      ),
                    ),
                    const SizedBox(width: 8),
                    Expanded(
                      child: _NumberField(
                        ...
                        primaryColor: primaryColor,
                        onChanged: (v) =>
                            onSettingsChanged(rightPadding: v.toDouble()),
                      ),
                    ),
                  ],
                ),
              ...
              // ── 수동 조절: 경계선 위치 입력 ───────────────
                ...
                Text('가로 경계선 위치 (px)', style: theme.textTheme.titleSmall),
                ...
                const SizedBox(height: 12),
                Text('세로 경계선 위치 (px)', style: theme.textTheme.titleSmall),
                const SizedBox(height: 2),
                Text(
              ...
              if (hasImage) ...[
                _InfoTile(
                  ...
                  subtitle:
                      '1컷 크기: ${_spriteSizeInfo(imageWidth!, imageHeight!)}  •  '
